...
void mushcursor_skip_markers      (mushcursor*, mushcoords, mushcell*);
void mushcursor_skip_semicolons   (mushcursor*, mushcoords, mushcell*);
void mushcursor_skip_spaces       (mushcursor*, mushcoords, mushcell*);
void mushcursor_skip_to_last_space(mushcursor*, mushcoords, mushcell*);
